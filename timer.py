...
def is_video_file(filename):
	...
	"""
	# Source : http://stackoverflow.com/questions/14919609/is-this-file-a-video-python
...
def getLength(filename):
	...
	"""
	# Source :http://stackoverflow.com/questions/3844430/how-to-get-the-duration-of-a-video-in-python/3844467#3844467
...
def get_time(filename):
	...
	"""
	# print getLength(loc)	# ['  Duration: 00:46:21.06, start: 0.000000, bitrate: 1054 kb/s\n']
...
def run_time(path,outstr,binge):
	...
	for episode in episodes:
		...
		outstr += "\t"+episode+"\t"+time+"\t\t"+str(binge[0])+":"+str(binge[1])+":"+str(binge[2])+"\n"
	
	print "\nTime to complete this season : ",binge[0],":",binge[1],":",binge[2]
	outstr += "\nTime to complete this season : "+str(binge[0])+":"+str(binge[1])+":"+str(binge[2])+"\n"
...
def main():
	...
	for each in seasons:
		...
		print "\n\n"
		outstr += "\nTotal time elapsed : "+str(total[0])+":"+str(total[1])+":"+str(total[2])+"\n\n\n"
